...
class AnalyticalMPCBasic:

    def __init__(self, mat_a, mat_b, mat_q, mat_r, prediction_horizon = 16, control_horizon = 4, antiwindup = 10**10):
        self.n_states = mat_a.shape[0]
        self.n_inputs = mat_b.shape[1]  


        self.phi, theta, q_aug, r_aug = self._matrix_augmentation(mat_a, mat_b, mat_q, mat_r, control_horizon, prediction_horizon)
    ...
    def _matrix_augmentation(self, a, b, q, r, control_horizon, prediction_horizon):
        ...
        return result_phi, result_theta, result_q_aug, result_r_aug
