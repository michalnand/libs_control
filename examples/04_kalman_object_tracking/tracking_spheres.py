...
if __name__ == "__main__":
    ...
    n_count = 3
    prediction_steps = 128

    noise_variance = 0.00001*0.001
    ...
    while True:
        ...
        for i in range(n_count):
            ...
            result_im = plot_trajectory(result_im, x_pred_v[:, i, :], (1, 0.5, 0.5))
        ...
        result_im = cv2.putText(result_im, "kalman velocity model prediction", (10, 80), cv2.FONT_HERSHEY_SIMPLEX , 0.8, (1, 0.3, 0.3), 2, cv2.LINE_AA) 
