...
lqg = LibsControl.LQGDDiscrete(a_disc, b_disc, c_disc, q, r, q_noise, r_noise)
...
#plot results
LibsControl.plot_closed_loop_response(t_result, u_result, x_result, x_hat = None, file_name = "lqgd_discrete_output.png", u_labels = "voltage [V]", x_labels = ["position [deg]", "velocity [deg/s]", "current [A]"])
